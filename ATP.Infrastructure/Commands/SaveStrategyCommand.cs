...
// </copyright>
// <summary>
//   Defines the SaveStrategyCommand type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace ATP.Infrastructure.Commands
{
    ...
    public class SaveStrategyCommand : CommandBase
    {
        ...
        {
            var filepath = this.fileBrowserService.SaveFile(this.Parent, ApplicationStrings.Title, Globals.FileFilterXml, Globals.StrategiesFolder);
