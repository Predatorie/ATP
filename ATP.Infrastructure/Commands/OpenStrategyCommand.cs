...
// </copyright>
// <summary>
//   Defines the OpenStrategyCommand type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace ATP.Infrastructure.Commands
{
    ...
    public class OpenStrategyCommand : CommandBase
    {
        ...
        {
            var filepath = this.fileBrowserService.BrowseForFile(this.Parent, ApplicationStrings.Title, Globals.FileFilterXml, Globals.StrategiesFolder, false);
